...
<template>
  <form @submit.prevent="handleSearchCustomers" class="mb-3 flex w-full flex-col items-center sm:flex-row">
    <InputText
      data-test="customers-search-input"
      v-model="searchInput"
      placeholder="Часть телефона"
      class="mb-2 w-full sm:mr-2 sm:mb-0 sm:w-fit"
    />
    <div class="flex w-full">
      <Button data-test="customers-search-submit" type="submit" class="w-full sm:w-fit">Поиск</Button>
